...
{
    cout<<"t1. Dr. Amit Singhal\t*Eye Specialist"<<endl<<endl;
    cout<<"t2. Dr. Sanjeev Kumar\t\t*Heart Specialist"<<endl<<endl;
    cout<<"t3. Dr. Abhinav Singh\t\t*Diabetic Specialist"<<endl<<endl;
    cout<<"t4. Dr. Pankaj Sharma\t\t*Heart Surgent"<<endl<<endl;
    cout<<"t5. Dr. Shorif Uddin\t\t*Eye Specialist"<<endl<<endl;
    cout<<"t6. Dr. Vinay Kumar\t\t*Diabetic Specialist"<<endl<<endl;
    cout<<"t7. Dr. Ajay Kumar\t\t*Medicine Specialist"<<endl<<endl;
    cout<<"t8. Dr. Rajeev Singh\t*Medicine Specialist"<<endl<<endl;
}
