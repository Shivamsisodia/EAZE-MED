...
{
    cout<<"t1. Dr. Abdullah Al Siraj\t*Eye Specialist"<<endl<<endl;
    cout<<"t2. Dr. Altaf Uddin Khan\t\t*Heart Specialist"<<endl<<endl;
    cout<<"t3. Dr. Emdadul Hoque\t\t*Diabetic Specialist"<<endl<<endl;
    cout<<"t4. Dr. Mostofa Zia\t\t*Heart Surgent"<<endl<<endl;
    cout<<"t5. Dr. Shorif Uddin\t\t*Eye Specialist"<<endl<<endl;
    cout<<"t6. Dr. Sifat Hossain\t\t*Diabetic Specialist"<<endl<<endl;
    cout<<"t7. Dr. Siddratul Islam\t\t*Medicine Specialist"<<endl<<endl;
    cout<<"t8. Dr. Mominul Hossain Raju\t*Medicine Specialist"<<endl<<endl;
}
